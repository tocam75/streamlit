...
def get_stock_info(market_type=None):
    ...
    if market_type == 'kospi':
        market_type_str = "stockMkt"  # 주식 종목이 코스피인 경우
    elif market_type == 'kosdaq':
        market_type_str = "kosdaqMkt"  # 주식 종목이 코스닥인 경우
    else:
        market_type_str = ""
    url = f"{base_url}?method={method}&marketType={market_type_str}"
...
# 시장 종류를 선택
market_type = st.sidebar.radio("시장 종류", ['kospi', 'kosdaq'])
